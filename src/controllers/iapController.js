...
export async function activateIAPSubscription(req, res) {
  try {
    ...
    // NOTE: Account credits are NOT applied for IAP purchases.
    // IAP prices are fixed in Google Play / App Store - we cannot reduce the store charge.
    // Credits only work with Stripe web payments where we control the invoice amount.
